    ...
    <div className="bg-[#33d6ad] mx-[96px] w-[90%]  xxl:mx-auto xxl:w-[1248px] text-[#131623] lg:my-20 rounded-[20px] max-container py-16">
      <div className="max-w-6xl px-4 lg:px-0 mx-auto text-center">
        ...
        <div className="flex justify-center items-center">
          <button className="font-poppins hover:text-[#33D6AD] font-semibold text-[#17131e] hover:bg-[#17131e] transition-all bg-[#33D6AD] lg:px-[32px] px-7 border py-[16px] rounded-[50px] border-[#17131e]">
            Subscribe Now
          </button>
        </div>
      </div>
